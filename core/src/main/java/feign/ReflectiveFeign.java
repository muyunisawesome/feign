...
public class ReflectiveFeign extends Feign {
    ...
    public <T> T newInstance(Target<T> target) {
        //通过ParseHandlersByName对象apply方法 生成 方法名与MethodHandler的映射关系
        Map<String, MethodHandler> nameToHandler = targetToHandlersByName.apply(target);
        //构建Method与其对应的MethodHandler的关系存放入methodToHandler，
        //主要用于在实际调用的时候，能够根据方法名获取对应的MethodHandler发起请求
        ...
        for (Method method : target.type().getMethods()) {
            if (method.getDeclaringClass() == Object.class) {
                ...
                methodToHandler.put(method, handler); //就是下面的dispatch
            } else {
                methodToHandler.put(method, nameToHandler.get(Feign.configKey(target.type(), method)));
            }
        }
        //通过InvocationHandlerFactory factory创建代理对象
        //默认ReflectiveFeign.FeignInvocationHandler
            ...
            for (MethodMetadata md : metadata) {
                ...
                if (md.isIgnored()) {
                    ...
                    result.put(md.configKey(),
                            //生成，factory为SynchronousMethodHandler.Factory
    ...
    private static class BuildTemplateByResolvingArgs implements RequestTemplate.Factory {
        ...
        public RequestTemplate create(Object[] argv) {
            //使用meta中的RequestTemplate，复制一份用来处理
        ...
        protected RequestTemplate resolve(Object[] argv,
            ...
            //直接交由RequestTemplate来拼接url，返回新的RequestTemplate
